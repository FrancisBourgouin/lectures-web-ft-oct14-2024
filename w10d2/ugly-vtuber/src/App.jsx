...
function App() {
  const [faceInfo, setFaceInfo] = useState({eyeLeftOpenPercentage:1, eyeRightOpenPercentage:1, mouthOpenPercentage:1})
  ...
  const extractPointInformation = (faceLandmarks) => {
    ...
    const eyeLeftHeight = calculateDistance3dPoints(faceLandmarks[386], faceLandmarks[374])
    const eyeRightHeight = calculateDistance3dPoints(faceLandmarks[159], faceLandmarks[145])
  ...
  return (
    ...
    <section className="Face">
      <div className="eyeLeft" style={{height:`${100 * faceInfo.eyeLeftOpenPercentage}%`}}></div>
      <div className="eyeRight" style={{height:`${100 * faceInfo.eyeRightOpenPercentage}%`}}></div>
      <div className="nose"></div>
      <div className="mouth" style={{height:`${100 * faceInfo.mouthOpenPercentage}%`}}></div>
    </section>
